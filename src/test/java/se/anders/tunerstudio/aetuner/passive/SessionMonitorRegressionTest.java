...
public final class SessionMonitorRegressionTest {
    ...
    private static void runningLowLoadTriggerFaultMustRemainCritical() {
        ...
        SessionReview review = SessionReview.build(Collections.<TransientEvent>emptyList(), snapshot);
    ...
    private static void keyOffActivityMustNotBecomeRunningFault() {
        ...
        String report = SessionReview.build(Collections.<TransientEvent>emptyList(), snapshot).toDisplayText();

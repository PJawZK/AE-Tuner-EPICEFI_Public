...
public final class RecommendationHistoryRegressionTest {
    ...
    private static void sessionDiagnosticsMustSummarizeRetainedEvidence() {
        ...
        List<TransientEvent> events = new ArrayList<TransientEvent>();
        events.add(new TransientEvent(1, true, "MAP Predict event", "", Arrays.asList(first, second), true));
        events.add(new TransientEvent(2, false, "Rejected", "test", Arrays.asList(first), true));

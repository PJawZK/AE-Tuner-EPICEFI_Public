...
enum GuidedWorkflowEvent {
    ...
    TARGET_ACQUIRED("ECU DETECTOR ACTIVE",
            "The ECU TPS AE detector reacted. This is detector activity only and does not mean the Guided maneuver was accepted or counted."),
    EVENT_ACCEPTED("GUIDED MANEUVER ACCEPTED - RETURN TO NORMAL THROTTLE",
            "A Guided maneuver passed its task-specific comparison gates and was retained as counting evidence."),
    EVENT_EXCLUDED("GUIDED MANEUVER NOT COUNTED - RETURN TO NORMAL THROTTLE",
            "The maneuver remains diagnostic or was invalid and did not advance the Guided comparison."),

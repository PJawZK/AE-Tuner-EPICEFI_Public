...
final class AeTableSuggestion {
    ...
    static AeTableSuggestion build(AeProjectSnapshot snapshot, List<EventSummary> events) {
        if (snapshot == null) {
    ...
    private static double eventTpsTo(EventSummary event) {

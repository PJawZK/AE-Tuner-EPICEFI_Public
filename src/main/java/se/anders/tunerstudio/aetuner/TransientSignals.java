...
final class TransientSignals {
    ...
    static boolean mapPredictionVisible(LiveSample sample) {
    ...
    static boolean wallWettingVisible(LiveSample sample) {
    ...
    static boolean instantFuelVisible(LiveSample sample) {
